...
<div class="flex py-6 gap-2">
	{#if listing.title}
      ...
      <input type="text" class="bg-gray-100 rounded p-1 max-w-64 w-full" placeholder="Title" bind:value={editingTitle}/>
  ...
  <div class="text-gray-500 hover:scale-110 hover:cursor-pointer hover:text-black transition ease-in-out" on:click={() => toggleEditing()}>
...
{/if}
  ...
  <div class="text-gray-500 hover:scale-110 hover:cursor-pointer hover:text-black transition ease-in-out" on:click={() => (showModal= true)}>
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
{#if editing}
      ...
      <textarea class="bg-gray-100 rounded p-1 min-h-96 w-full" placeholder="Description" bind:value={editingDescription}/>
...
<div class="p-1 mt-5">
      ...
      <input type="text" class="bg-gray-100 rounded p-1 w-full" placeholder="Tags (Comma seperated)" bind:value={editingTags}/>
