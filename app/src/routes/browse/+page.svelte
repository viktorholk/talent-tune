...
<div on:click={selectJobListing(jobListing._id)} class="rounded {jobListing.active ? ' border border border-indigo-700' : ''} flex-grow hover:scale-105 transition ease-in-out">
    <Card  props={{...{
