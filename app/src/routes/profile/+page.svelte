...
<div class="flex justify-between">
    ...
    <div class="flex flex-col">
      ...
      <input type="text" class="bg-gray-100 flex-grow h-8 p-2 rounded " bind:value={editingCompanyName}/>
    ...
    <div class="flex flex-col">
      ...
      <input type="text" class="bg-gray-100 flex-grow h-8 p-2 rounded " bind:value={editingCompanyVat} />
  ...
  <div class="flex flex-col">
      ...
      <textarea class="bg-gray-100 flex-grow h-14 max-h-24 p-2 rounded " bind:value={editingCompanyDescription} />
...
<div class="flex flex-col">
  ...
  <div class="flex flex-col">
      ...
      <input type="text" class="bg-gray-100 flex-grow h-8 p-2 rounded" bind:value={editingCompanyCity} />
...
<div class="flex flex-col">
      ...
      <input type="text" class="bg-gray-100 flex-grow h-8 p-2 rounded" bind:value={editingCompanyAddress} />
  ...
  <div class="flex flex-col">
      ...
      <input type="text" class="bg-gray-100 flex-grow h-8 p-2 rounded" bind:value={editingCompanyZip} />
  ...
  <button class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-full" on:click={() => handleSave()}>Save</button>
  </div>
  ...
  <div class="flex flex-col">
      ...
      <textarea class="bg-gray-100 flex-grow h-14 max-h-24 p-2 rounded " bind:value={editingProfileBiography} />
  ...
  <h2 class="font-bold text-sm px-1">Your Documents</h2>
		...
		<table class="w-full text-left border-collapse">
				...
				{#each data.profile.documents as document}
					<tr class="">
						<td class="border-b border-grey-light"><p class="text-ellipsis overflow-hidden text-nowrap w-72">{document.title}</p></td>
						<td class="border-b border-grey-light">
            <div class="flex justify-center items-center">

<div on:click={handleRemoveFile(document._id)} class="text-red-500 hover:scale-125 hover:cursor-pointer transition ease-on-out">
...
<div class="flex flex-col gap-2">
  ...
  <input type="email" class="bg-gray-100 text-gray-300 flex-grow h-8 p-2 rounded text-xl" value={user.email} disabled/>
  </div>
